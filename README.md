...
A file named `requireAllSpecs.js` will
be created, and it will contain JavaScript code that will "require" all files (via the `define()` function) matching the glob pattern `**/*Spec.js`, relative to the specified
path (`test/`).
