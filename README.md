...
[![Build Status](https://travis-ci.org/bruceharris/grunt-amd-require-tests.png?branch=master)](https://travis-ci.org/bruceharris/grunt-amd-require-tests)
...
Recommended usage is to include this task in your [grunt-contrib-watch](https://www.npmjs.org/package/grunt-contrib-watch) tasks so newly added test files will automatically be run.
